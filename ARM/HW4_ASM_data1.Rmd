...
# start a file
Trans <- file.create('TransactionTweetsFile')
# open the file
Trans <- file('TransactionTweetsFile', open = "a")

## Tokenize to words 
Tokens<-tokenizers::tokenize_words(
  tweet$text[1],stopwords = stopwords::stopwords("en"), 
...
TweetTrans_rules = arules::apriori(TweetTrans, 
        parameter = list(support=.03, conf=1, minlen=2))
...
networkD3::saveNetwork(D3_network_Tweets, 
                       "NetD3_wildfireL.html", selfcontained = TRUE)
```
